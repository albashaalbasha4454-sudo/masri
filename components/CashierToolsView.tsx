...
const CashierToolsView: React.FC<CashierToolsViewProps> = ({ currentUser }) => {
    ...
    const handleExport = () => {
        try {
            ...
            link.download = `restaurant_backup_${currentUser.username}_${date}.json`;
            link.click();
            ...
            <div className="max-w-2xl mt-6 space-y-8">
                ...
                <div className="bg-white shadow-lg rounded-xl p-6">
                    ...
                    <div className="p-4 bg-red-50 border-r-4 border-red-400 text-red-800 rounded-md">
                        ...
                        <p className="text-sm mt-1">
                        سيؤدي استيراد البيانات إلى الكتابة فوق **جميع** بياناتك الحالية على هذا الجهاز. استخدم هذه الميزة لاستقبال تحديثات من المدير (مثل قائمة أصناف جديدة).
                        </p>
                    </div>
                    <div className="mt-4">
